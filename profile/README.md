Daisōgen is a flat operating system: all processes run in kernel mode, or ring 0, with full permissions. _One Page Table to rule them all_. This makes it easy and fun to work with,
